...
createNewExternalWallet walletMeta encodedExtPubKey = do
    ...
    walletId <- makeWalletIdFrom encodedExtPubKey
    ...
    -- I have to store PublicKey for external wallet, it will be used during synchronization
    -- with the blockchain.
  ...
  where
    makeWalletIdFrom encodedXPub = do
        ...
        return $ encodeCType . makePubKeyAddressBoot $ PublicKey xPub
